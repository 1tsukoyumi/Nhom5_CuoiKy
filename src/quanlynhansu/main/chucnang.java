...
public class chucnang implements Initializable {
    ...
    ObservableList<nhanvien> nhanvienList = FXCollections.observableArrayList(
            new nhanvien(1, "Ho Nguyen Thanh", "nguyenthanh@gmail.com", 20, "Bien Hoa", 10, "Male", "Technology", "Manager", 40000),
            new nhanvien(2, "Tran Minh Vu", "minhvu@gmail.com", 20, "Bien Hoa", 20, "Male", "Technology", "CEO", 180000),
            new nhanvien(3, "Dao Le Ngoc Anh", "ngocanh@gmail.com", 20, "Bien Hoa", 20, "Female", "Technology", "Founder", 100000)
    );

    public chucnang() throws FileNotFoundException {
    }
